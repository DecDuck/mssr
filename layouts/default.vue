<template>
  <div>
            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              >
                <div class="flex h-16 shrink-0 items-center">
                  <Logo class="h-8 w-auto text-blue-600" alt="" />
                </div>
    ...
    >
      ...
      >
        <div class="flex h-16 shrink-0 items-center">
          <Logo class="h-8 w-auto text-blue-600" />
        </div>
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
            ...
            <li class="-mx-6 mt-auto">
              ...
              >
                ...
                <span aria-hidden="true">My username</span>
              </div>
            </li>
          </ul>
        </nav>
...
const navigation = [
  ...
  { name: "Packages", href: "/package", icon: DocumentIcon },
  { name: "Access", href: "/access", icon: LockClosedIcon },
...
const currentRouteIdx = computed(() => {
  for (let i = navigation.length - 1; i >= 0; i--) {
    if (route.fullPath.startsWith(navigation[i].href)) {
      return i;
    }
  }
  return -1;
